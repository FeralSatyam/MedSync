...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50/70 via-slate-50 to-slate-50">
      <Navbar />
      <main className="mx-auto max-w-6xl px-4 py-8 md:px-6">
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-slate-900">Medicine dashboard</h1>
            <p className="mt-1 text-gray-500">Select a family member and manage stock.</p>
          </div>
          <div className="flex flex-wrap gap-2 md:justify-end">
            <Link
              to="/patients"
              className="rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm transition hover:bg-gray-50"
            >
              Manage profiles
            </Link>
            {selectedId && (
              <>
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-xl border border-teal-200 bg-white px-4 py-2 text-sm font-medium text-teal-700 shadow-sm transition hover:bg-teal-50"
                >
        ...
        {loading ? (
          ...
          <>
            ...
            {alerts.length > 0 && (
              <div
                className="mb-6 rounded-2xl border border-amber-300 bg-amber-50 px-4 py-3 text-amber-950 shadow-sm"
                role="status"
              >
        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-6 shadow-xl">
            ...
            <input
              type="number"
              min={0}
              className="mt-4 w-full rounded-xl border border-slate-300 px-3 py-2 focus:border-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-100"
              value={restockQty}
